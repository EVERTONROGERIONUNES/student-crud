                        ...
                        <?php else: ?>
                            ...
                            <div class="col-lg-4 col-md-6 mb-4">
                                <div class="card h-100">
                                  ...
                                  <div class="card-body">
                                    <h4 class="card-title text-md-center">
                                      <a href="<?php echo e(route('class.index')); ?>">Turmas</a>
                                    </h4>
                                  </div>
                                </div>
                            </div>
...
<?php /**PATH F:\OneDrive-Etec\OneDrive - Etec Centro Paula Souza\FATEC\SEMESTRE V\DSII\school-system\resources\views/layouts/app.blade.php ENDPATH**/ ?>