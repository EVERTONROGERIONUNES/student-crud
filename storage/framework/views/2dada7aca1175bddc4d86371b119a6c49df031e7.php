        ...
        <?php if(isset($courses)): ?>
            <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td class="text-md-center"><a href="<?php echo e(route('course.show', $course->id)); ?>"><button class="btn btn-primary">Visualizar</button></a></td>
...
<?php echo $__env->make('templates.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\OneDrive-Etec\OneDrive - Etec Centro Paula Souza\FATEC\SEMESTRE V\DSII\school-system\resources\views/course/index.blade.php ENDPATH**/ ?>